...
import {
  ...
  import { HeaderMain, FooterMain } from "../../styles/styled-components/StyledText";
...
const JobProgress = (props) => {
    const {handleSelect, select, month, currentWeek, averageDailySaved, jobsSaved, jobsApplied, jobsInterviewing, authState} = props
    return (
        <>
